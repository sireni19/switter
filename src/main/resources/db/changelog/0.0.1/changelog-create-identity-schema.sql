...
--changeset MikhailProkopovich:create-identity-schema;
--comment create new identity schema;

create schema identity;
--rollback drop schema identity;

--changeset MikhailProkopovich:create-identity-user_accounts-table;
...
--changeset MikhailProkopovich:create-user_roles-table;
...
--changeset MikhailProkopovich:create-user_accounts_roles-table;
...
--changeset MikhailProkopovich:add-user_accounts_roles-table-constraints;
...
--changeset MikhailProkopovich:add-data-to-user_roles-table;
